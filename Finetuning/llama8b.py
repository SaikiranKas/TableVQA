...
docker run --rm --gpus '"device=7"'   -v /projects/data/vision-team/saikiran_kasturi/github/doc_fm_propositon3/doc_fm_proposition_3/llama8bresults:/llama8bresults   -it llama8b bash
huggingface-cli login
python src/model/llama8b.py
"""
